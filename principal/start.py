...
# Img OpenCV
# Leer imagenes
img_info = cv2.imread("/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/SetUp/Info.png")
img_check = cv2.imread("/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/SetUp/check.png")
img_step0 = cv2.imread("/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/SetUp/Step0.png")
img_step1 = cv2.imread("/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/SetUp/Step1.png")
img_step2 = cv2.imread("/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/SetUp/Step2.png")
img_liche = cv2.imread("/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/SetUp/LivenessCheck.png")


# Path
OutFolderPathUser = '/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/DataBase/Users'
PathUserCheck = '/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/DataBase/Users/'
OutFolderPathFace = '/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/DataBase/Faces'
...
def Log_Biometric():
    print("Log_Biometric")
    global pantalla, pantalla2, conteo, parpadeo, img_info, step, cap
...
def Log():
    ...
    if len(RegName) == 0 or len(RegUser) == 0 or len(RegPass) == 0:
        ...
        if RegUser in UserName:
            ...
            cap.set(3, 1280)
            cap.set(4, 720)
            print("Log_Biometric 0.0")
            Log_Biometric()


def Sign_Biometric():
    global pantalla, pantalla3, conteo, parpadeo, img_info, step, UserName, prueba, cap
    cap = cv2.VideoCapture(0)
    # Leemos la videocaptura
    if cap is not None:
        ret, frame = cap.read()
        ...
        if ret == True:
            ...
            if res.multi_face_landmarks:
                ...
                for rostros in res.multi_face_landmarks:
                    ...
                    # Draw Face Mesh
                    #mpDraw.draw_landmarks(frame, rostros, FacemeshObject.FaceMesh, ConfigDraw, ConfigDraw)
...
# Ventana principal
pantalla = Tk()
pantalla.title('FaceRecognition')
pantalla.geometry('1280x720')

# Fondo
imagenF = PhotoImage(file="/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/SetUp/Inicio.png")
...
# Botones
# Registro
imagenBR = PhotoImage(file="/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/SetUp/BtSign.png")
BtReg = Button(pantalla, text="Registro", image=imagenBR, height="40", width="200", command=Log)
BtReg.place(x=300, y=580)

# Inicio de sesion
imagenBL = PhotoImage(file="/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/SetUp/BtLogin.png")
BtSign = Button(pantalla, text="Sign", image=imagenBL, height="40", width="200", command=Sign)
BtSign.place(x=850, y=580)

# Fondo 2
imagenB = PhotoImage(file="/Users/josuedurandpebe/Desktop/FaceRecognition/example/pythonProject/SetUp/Back2.png")
